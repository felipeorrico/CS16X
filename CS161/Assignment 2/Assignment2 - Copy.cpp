 ...
 int main () { //main function to execute everything
	...
	if (boss_level == 1) { //if you chose to go to the castle this will be executed.
		...
		if (fight1 == 1) { //if you choose fireball this will be executed.
			cout << "You cast a FIREBALL at the creature and the creature absorbs it! It says 'Do you think something that small can hurt me? you haven't seen anything!' After the Smoke clears you can see what the creature looks like. The creature is a Massive Gummy bear.  'It's now my turn, you fool!'" << endl;
			cout << "The Massive Gummy Bear breaks the altar and throws it in your direction with incredible speed. You can ether dodge it or send it back with a return spell." << endl;
			bool trigger3 = 0;
			int fight2;
			do { //fight 2
				if (trigger3){
			...
			if (fight2 == 1) { //if you chose dodge this will be executed
				cout << "You manage to dodge the altar but barely. The gummy bear then yells 'I wont be defeated by a mere spell caster! I'm much stronger than this!'. " << endl;
				cout << "The Massive Gummy Bear is angry and starts shooting Gummy Minions at you. \n You get hit and they start biting you. Their bites are poisonous and so you cant take more than a few." << endl;
				cout << "You can either choose to summon your own minions to destroy the gummy minions or Launch a controllable ice spear at them so you can kill all of them with one hit." << endl;
				bool trigger4 =0;
				int fight3;
				do { //fight 3
					if (trigger4) {
				...
				if (fight3 == 1) { //if you chose minions this will be executed.
					cout << "You summon your minions and they manage to destroy their gummy counterparts. However you took too long to do so and your blood is now filled with a deadly poison." << endl;
					...
					if (fight4 == 1) { //if you choose to cast the spell this will be executed.
						if (random > 5) { //spell worked from random number
							cout << "Your spell worked! The Massive Gummy Bear then falls to its knees and melts. By his side there is the antidote to the poison." << endl;
						...
						cout << "You sacrificed yourself so no one else would die for the Massive Gummy Bear!" << endl;
					...
					cout<< "You Launch the Ice spear and destroy all of the minions on time! The Massive Gummy Bear shoots the spear back at you and "<<endl;
					...
					if (fight5 == 1) { //if you chose to control this will be executed.
						...
						cout << "You dodge the spear and cast your spell. The Massive Gummy Bear then falls to its knees and melts" <<endl;
						cout << "You Win "<< player_name<< "Here are your spoils..." << endl;
						return 0;
					}
				}
				...
				cout << "You cast the Return Spell and the Altar is sent back at the Massive Gummy Bear with incredible speed! The Bear then "<<endl;
				cout << "crushes it with a punch and releases a horde of Gummy Minions at you. You take some damage and they start biting you!"<<endl;
				cout << "You can either choose to summon your own minions to destroy the gummy minions or Launch a controllable ice spear"<< endl;
				...
				if (fight6 == 1) { //if you chose minions this will be executed.
					cout << "You summon your minions and they manage to destroy their gummy counterparts. The Massive bear then Launches a fireball at you." << endl;
			...
			cout << "that you are dealing with something very dangerous, a Massive Gummy Bear."<< endl;
			cout << "The Massive Gummy Bear is angry and starts shooting Gummy Minions at you." << endl;
			...
			if (fight2 == 1) { //if you chose minions this will be executed.
				cout << "You summon your minions and they manage to destroy their gummy counterparts. However you took too long to do so ";
				...
				if (fight3 == 1) { //if you chose the spell this will be executed
					...
					if (fight4 == 1) { //if you chose lightning random will be executed from below
						if (random > 5) { //spell worked
							cout << "Your spell worked! The Massive Gummy Bear died. By his side there is the antidote to the poison." << endl;
							cout << "You Win "<< player_name << "! Here are your Spoils..." << endl;
							return 0;
						}
						else { //spell did not work
				...
				cout << "The bear gets angry and shoots a chunk of gummy substance at you!" << endl;
				cout << "You can either Dodge the gummy substance or cast the ultra eating spell." << endl;
				bool trigger7 = 0;
				int fight6;
				do { //fight 6
					if (trigger7){
				...
				if (fight6 == 1) { //if you chose dodge this will be executed.
					cout << "You dodge the chunk of gummy. The Bear then launches a fireball at you." << endl;
					cout << "You can either Cast a Poisonous Fire Extinguish Spell or Dodge it." << endl;
					bool trigger8 =0;
					int fight7;
					do { //fight 7 starts here
					...
					cout << "you realize you can't walk anymore, the gummy paralyzed your legs. you can either accept your faith or cast " <<endl;
					...
					if (fight8 == 1){ //if you chose faith this will be executed
						...
						cout << "The Gummy bear separated your head from your body. You died." << endl;
						cout << "This is the end of your journey in Arcadia "<< player_name << endl;
						cout << "Thank you for playing!	"<< endl;
						return 0;
					}
					else if (fight8 == 2) { //if you chose RECTIFIER this will be executed.
						cout << "Your Rectifier spell did not work. The Gummy Bear then separated your head from your body. You Died." << endl;
						cout << "This is the end of your journey in Arcadia "<< player_name << endl;
						cout << "Thank you for playing!	"<< endl;
						return 0;
					}
