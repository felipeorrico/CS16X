 ...
 ******************************************************************************/
 ...
 void fancy (int fprint) { //this will check the value of the variable and output a string that corresponds to its value.
 ...
 int* gamePlay (int a, int b, int c, int play, string player1) { //game function .. the game runs here.
	...
	int stones;
	string play1; //defines choice of pile
	...
	++play; //increments the play number to know whose turn it is.
	
	int* array = new int[4]; //creates an array to return the results of the play to the main function.
	array[0]= a;
	array[1]= b;
	array[2]= c;
	array[3]= play;
